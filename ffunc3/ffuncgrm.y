...
%token READ LET IN CR UNIT ARROBA
...
decls: dec decls					{ $1::$2 }
	|						{ [] }
	;
dec: FUN ID PI ID DOSP tipo PD DOSP tipo IGUAL exp END
							{ Func{f=$2, arg=($4, $6), body=$11, tipo=$9, pr=0} }
	;
tipo: TIPO						{ $1 }
...
expf : ID	 					{ Id $1 }
	...
	| %prec APP exp ARR  expf			{ Call($3, $1) }
	;
